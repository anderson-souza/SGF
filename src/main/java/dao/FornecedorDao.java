...
public class FornecedorDao extends DaoPadrao {
    ...
    public boolean inserir() {
        try {
            ...
            fornecedor.setId(pegaGenerator("GFORNECEDORES"));
            ...
            ps.setInt(16, fornecedor.getCidade().getId());
    ...
    public boolean alterar() {
        try {
            ...
            ps.setString(1, fornecedor.getTipoFornecedor());
    ...
    public boolean consultar() {
        try {
            ...
            if (rs.next()) {
                ...
                fornecedor.setTipoFornecedor(rs.getString(2));
                ...
                fornecedor.getCidade().setId(rs.getInt(16));
    ...
    public boolean duplicidade() {
        try {
            ...
            ps.setString(1, fornecedor.getRazaoSocial());//NOMRAZ = ? or CPFNPJ = ? or RGIE = ?
            ps.setString(2, fornecedor.getCpfcnpj());
            //ps.setString(3, fornecedor.getRgie());
            ResultSet rs = ps.executeQuery();
            if (rs.next()) {
                if (rs.getString("NOMRAZ").equals(fornecedor.getRazaoSocial()) || rs.getString("CPFCNPJ").equals(fornecedor.getCpfcnpj())
                        && rs.getInt("CODFOR") != fornecedor.getId()) { //|| rs.getString("RGIE").equals(fornecedor.getRgie())
